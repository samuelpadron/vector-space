"""
Script by Xiang-Li Li: https://github.com/li-xl/nuscenes-download

This script is used to download and extract the nuScenes dataset.
Please replace your email and password in the script before running it.
"""
...
output_dir = "dir_to_save_nuscenes" # e.g. /home/user/nuscenes
